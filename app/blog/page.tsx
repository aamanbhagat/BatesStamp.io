...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://www.batesstamp.pro";
...
export const metadata: Metadata = {
  title: "Blog — BatesStamp",
  description: "Guides and explainers on Bates numbering, discovery production and legal document workflows.",
      ...
      <main className={styles.wrap}>
        <header className={styles.head}>
          ...
          <p className={styles.lede}>
            Clear, practical guides on Bates numbering, discovery production and
            legal document workflows — written to be read, not skimmed.
          </p>
        </header>
